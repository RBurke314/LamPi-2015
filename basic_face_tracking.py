...
while True:
    ...
    for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
        ...
        cv2.line(resized, ((xaxismid - (offset / scaling)) * scaling, 0),
                 ((xaxismid - (offset / scaling)) * scaling, resy * scaling), (0, 255, 0), 1)
        cv2.line(resized, ((xaxismid + (offset / scaling)) * scaling, 0),
                 ((xaxismid + (offset / scaling)) * scaling, resy * scaling), (0, 255, 0), 1)
        cv2.line(resized, (0, (yaxismid - (offset / scaling)) * scaling),
                 (resx * scaling, (yaxismid - (offset / scaling)) * scaling), (0, 255, 0), 1)
        cv2.line(resized, (0, (yaxismid + (offset / scaling)) * scaling),
                 (resx * scaling, (yaxismid + (offset / scaling)) * scaling), (0, 255, 0), 1)
        ...
        if faces != ():
            ...
            if cface[0] < (xaxismid - (offset / scaling)) * scaling:
                servo0 = servo0 + step
            if cface[0] > (xaxismid + (offset / scaling)) * scaling and cface[0] < (
                xaxismid - (offset / scaling)) * scaling:
                servo0 = servo0
